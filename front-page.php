...
?>
    ...
    <section class="section-contents" id="shop">
      <div class="wrapper">
<?php
$shop_obj = get_page_by_path( 'business' );
$post = $shop_obj;
setup_postdata( $post );
$shop_title = get_the_title();
?>
        <span class="section-title-en">Business Information</span>
        <h2 class="section-title"><?php the_title(); ?></h2>
        <p class="section-lead"><?php echo get_the_excerpt(); ?></p>
          ...
          <li class="shops-item">
            <a class="shop-link" href="<?php the_permalink(); ?>">
              ...
              <div class="shop-body">
                ...
                <div class="buttonBox">
                  <button type="button" class="seeDetail">詳細を見る</button>
                </div>
              </div>
            </a>
          </li>
...
?>          
        ...
        <div class="section-buttons">
          <button type="button" class="button button-ghost" onclick="javascript:location.href = '<?php echo esc_url( home_url( 'business' ) ); ?>';">
